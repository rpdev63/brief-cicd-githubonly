...
class RSAAlgo(EncryptionInterface):
    ...
    def encrypt(self, message, key=0):
        ...
        if not isinstance(message, str):
            ...
            self.logger.error(
                "Error during the encryption of a message with RSA. The message must be a string")
            return False

        if not isinstance(key, str):

            self.logger.error(
                "Error during the encryption of a message with RSA. The key must be a string")
            return False
    ...
    def decrypt(self, message, key=0):
        ...
        if not isinstance(message, str):
            ...
            self.logger.error(
                "Error during the decryption of a message with RSA. The message must be a string")
            return False

        if not isinstance(key, str):

            self.logger.error(
                "Error during the decryption of a message with RSA. The key must be a string")
            return False
