...
from app.models.caesarcipher_algo import CaesarCipher
...
class CaesarCipherBlueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        self.add_url_rule(url + "/encryption", "caesar_cipher_encryption",
                          self.displayEncryptedText, methods=["POST"])
        self.add_url_rule(url + "/decryption", "caesar_cipher_decryption",
