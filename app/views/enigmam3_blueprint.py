...
from app.views.baseblueprint import BaseBlueprint
from app.models.enigmam3_algo import EnigmaM3
...
class EnigmaM3Blueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        self.add_url_rule(url + "/encryption", "enigmam3_encryption",
                          self.displayEncryptedText, methods=["POST"])
        self.add_url_rule(url + "/decryption", "enigmam3_decryption",
                          self.displayDecryptedText, methods=["POST"])
    ...
    def displayEncryptedText(self):
        ...
        settings = []
        settings.append((request.form["first_rotor_start"],
                        request.form["second_rotor_start"], request.form["third_rotor_start"]))
        settings.append((int(request.form["first_rotor_used"]), int(
            request.form["second_rotor_used"]), int(request.form["third_rotor_used"])))
        settings.append(
            (request.form["ring_settings_1"], request.form["ring_settings_2"], request.form["ring_settings_3"]))
