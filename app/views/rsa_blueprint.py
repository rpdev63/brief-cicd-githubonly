...
from app.models.rsa_algo import RSAAlgo
...
class RSABlueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        self.add_url_rule(url + "/encryption", "rsa_encryption",
                          self.displayEncryptedText, methods=["POST"])
        self.add_url_rule(url + "/decryption", "rsa_decryption",
                          self.displayDecryptedText, methods=["POST"])
        self.add_url_rule(url + "/keysgeneration", "rsa_keys_generation",
                          self.displayKeysPair, methods=["POST"])
