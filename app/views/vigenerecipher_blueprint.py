...
from app.models.vigenerecipher_algo import VigenereCipher
...
class VigenereCipherBlueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        self.add_url_rule(url + "/encryption", "vigenere_cipher_encryption",
                          self.displayEncryptedText, methods=["POST"])
        self.add_url_rule(url + "/decryption", "vigenere_cipher_decryption",
